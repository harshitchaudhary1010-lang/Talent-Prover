...
<section class="login-card fade-in">
        ...
        <div class="form-group">
            ...
            <div class="input-wrapper">
                ...
                <input type="email" name="email" class="form-input" placeholder="you@gmail.com" required
                       value="<?= htmlspecialchars(strtolower(trim($_POST['email'] ?? ''))) ?>"
                       pattern="[a-z0-9._%+\-]+@gmail\.com" title="Use a valid @gmail.com address"
    ...
    <p class="text-center text-slate-500 text-sm mt-2">
        Hiring talent?
        <a href="/auth/register.php?role=company" class="text-emerald-700 hover:text-emerald-800 font-black transition-colors">Create company account</a>
    </p>
</section>
</main>
